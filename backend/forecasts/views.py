...
def forecast_performance(request):
    ...
    horizon_config = {
        "24H": {"days": 4, "max_points": 96},
        "30D": {"days": 60, "max_points": 60},
        "12W": {"days": 360, "max_points": 52},
        "12M": {"days": 1460, "max_points": 48},  # 2 years
    }
    
    config = horizon_config.get(horizon, {"days": 4, "max_points": 96})
