...
import { CATEGORIES, HORIZONS, Horizon } from "@/config/marketsData";
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-neutral-200 bg-neutral-50 py-2 pl-10 pr-4 text-sm transition-colors focus:border-[var(--brand)] focus:bg-white focus:outline-none dark:border-neutral-700 dark:bg-neutral-800 dark:text-white sm:w-52"
                />
              </div>
