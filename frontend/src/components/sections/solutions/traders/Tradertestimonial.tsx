...
const TESTIMONIALS = [
  {
    id: 1,
    quote:
      "I used to second-guess every entry. Now I check the confidence score and know immediately if this is a setup worth sizing into or one to skip.",
    name: "Alex Chen",
    role: "Day Trader",
    experience: "Trading crypto since 2019",
    metric: {
  ...
  },
  {
    id: 2,
    quote:
      "The direction flip alerts alone are worth it. I got notified when BTC sentiment shifted bearish 6 hours before the drop. Saved my position.",
    name: "Marcus Wright",
    role: "Swing Trader",
    experience: "Full-time trader, 5+ years",
    metric: {
  ...
  },
  {
    id: 3,
    quote:
      "Finally, a tool that quantifies what I was trying to feel. The confidence bands help me set realistic profit targets instead of hoping for moon shots.",
    name: "Sarah Kim",
    role: "Technical Analyst",
    experience: "Former institutional trader",
    metric: {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6">
        ...
        >
          <p className="text-xs text-neutral-400 dark:text-neutral-500">
            * Testimonials represent individual experiences. Results vary based
            on trading strategy and market conditions.
          </p>
        </div>
          ...
          {[
            {
              ...
              subtext: "using Nordict daily",
            },
            {
              value: "89%",
              label: "Would recommend",
              subtext: "to fellow traders",
            },
            {
              value: "4.8/5",
              label: "Average rating",
              subtext: "from user surveys",
            },
          ].map((stat) => (
            <div
              key={stat.label}
...
export default TraderTestimonial;
