  ...
  return (
    <section className="relative overflow-hidden bg-white pt-8 pb-12 dark:bg-black">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        ...
        >
          <div className="inline-flex items-center gap-3 rounded-2xl border border-neutral-200 bg-neutral-50 p-1.5 dark:border-neutral-800 dark:bg-neutral-900">
            {/* Monthly */}
            <button
        ...
        {/* Trust note */}
        <div
          className={`mt-6 flex justify-center transition-all duration-700 ease-out ${
